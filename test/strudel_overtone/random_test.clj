...
(deftest signal-test
  (testing "sine-sig signal"
    (is (approx= 0.5 (sut/sine-sig 0.0 nil)))
    (is (approx= 1.0 (sut/sine-sig 0.25 nil)))
    (is (approx= 0.5 (sut/sine-sig 0.5 nil)))
    (is (approx= 0.0 (sut/sine-sig 0.75 nil))))

  (testing "saw-sig signal"
    (is (= 0.0 (sut/saw-sig 0.0 nil)))
    (is (= 0.5 (sut/saw-sig 0.5 nil)))
    (is (= 0.0 (sut/saw-sig 1.0 nil))))

  (testing "tri-sig signal"
    (is (= 0.0 (sut/tri-sig 0.0 nil)))
    (is (= 1.0 (sut/tri-sig 0.5 nil)))
    (is (= 0.0 (sut/tri-sig 1.0 nil))))

  (testing "sig-range scaling"
    (let [s (sut/sig-range sut/sine-sig 100 200)]
